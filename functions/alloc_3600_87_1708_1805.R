...
tmp <- foreach(i = 1:200) %dorng%{
  bio_equal(p_neg = p_nac, p_pos = p_enro,  p_new1 = p_enro, sigma = 0, re_sigma = 0, data_prev = BRD_long,n_iter = 50, pig_alloc = c(87,1708,1805))
}
stopCluster(cl)
...
write.csv(BE, file = "./res/alloc_3600_87_1708_1805.csv", row.names = F)
