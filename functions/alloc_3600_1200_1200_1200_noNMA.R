...
tmp <- foreach(i = 1:200) %dorng%{
  bioeq_single_s(pig_alloc = c(1200, 1200, 1200), p_nac = p_nac, p_enro = p_enro, p_new1 = p_enro, n_iter = 50)
}
stopCluster(cl)
...
write.csv(BE, file = "./res/alloc_3600_1200_1200_1200_noNMA.csv", row.names = F)