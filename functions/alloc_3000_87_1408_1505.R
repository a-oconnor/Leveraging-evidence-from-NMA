...
tmp <- foreach(i = 1:200) %dorng%{
  bio_equal(p_neg = p_nac, p_pos = p_enro,  p_new1 = p_enro, sigma = 0, re_sigma = 0, data_prev = BRD_long,n_iter = 50, pig_alloc = c(87,1408,1505))
}
stopCluster(cl)
...
write.csv(BE, file = "./res/alloc_3000_87_1408_1505.csv", row.names = F)
