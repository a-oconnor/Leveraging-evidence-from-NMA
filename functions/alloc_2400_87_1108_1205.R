...
tmp <- foreach(i = 1:200) %dorng%{
  bio_equal(p_neg = p_nac, p_pos = p_enro,  p_new1 = p_enro, sigma = 0, re_sigma = 0, data_prev = BRD_long,n_iter = 50, pig_alloc = c(87,1108,1205))
}
stopCluster(cl)
...
write.csv(BE, file = "./res/alloc_2400_87_1108_1205.csv", row.names = F)
